...
from langchain.evaluation.loading import load_evaluator  # ✅ Corrected Import
from src.mcqgenerator.utils import read_file, get_table_data
from src.mcqgenerator.logger import logging
from src.mcqgenerator.MCQGenerator import logging

# ✅ Fix JSON path issue (Use raw string)
with open(r"C:\GenAI_Projects\Project1\response.json", "r") as file:
...
with st.form("user_inputs"):
    ...
    button = st.form_submit_button("Create MCQs")  # ✅ Fixed typo
    ...
    if button and upload_file is not None and mcq_count and subject and tone:
        with st.spinner("Loading..."):
            try:
                ...
                # ✅ Replace generate_evaluate_chain with load_evaluator
                evaluator = load_evaluator("qa")  # Choose "qa", "criteria", or other evaluators
